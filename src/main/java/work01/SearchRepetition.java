...
public class SearchRepetition {
   ...
   private static String xin ="ucarintrdriver" +
    ...
    public  static  Set<String>  filterRepetition(){
        Set<String> setOld =new HashSet<String>();
        Set<String> setXin =new HashSet<String>();
        Set<String> setResult =new HashSet<String>();

        String[] strOld= old.toLowerCase().split(",");
        String[] strXin= xin.toLowerCase().split(",");
